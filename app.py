...
def embed_demo():
    ...
    if request.method == "POST":
        ...
        if not gif_file or not gif_file.filename.endswith(".gif"):
            ...
            try:
                # Save uploaded GIF
                gif_filename = secure_filename(gif_file.filename)
                ...
                result = {
                    ...
                    'original_size': embedding_result['original_size'],
                    'embedded_size': embedding_result['embedded_size'],

...
import base64
import re
from intelligence_engine import analyze_file, extract_payload
# === Config ===
...
def analyze_gif_with_gemini(gif_path, api_key=None):
    """
    Analyze GIF using advanced pattern recognition engine.
    Delegates to intelligence_engine module.
    """
    return analyze_file(gif_path, api_key)
